<template>
  ...
  <ModalDialog id="creditsModal" :title="t('footer.credits')">
    <template #body>
      <h4><a href="https://boardgamegeek.com/boardgame/182874/grand-austria-hotel" target="_blank" rel="noopener">{{t('gameTitle')}}</a></h4>
      <dl>
        <dt>Game design</dt>
        <dd>Virginio Gigli, Simone Luciani</dd>
        <dt>Artist</dt>
        <dd>Klemens Franz</dd>
        <dt>Solo Mode Design</dt>
        <dd>Mauro Gibertoni, Simone Luciani, Virginio Gigli</dd>
        <dt>Publisher</dt>
        <dd><a href="https://www.lookout-spiele.de/" target="_blank" rel="noopener">Lookout Games</a></dd>
      </dl>
      ...
      <dl>
        ...
        <dt>Version</dt>
        <dd>{{buildNumber}} (<a href="https://github.com/brdgm/grand-austria-hotel-solo-helper/releases" target="_blank" rel="noopener">Change Log</a>)</dd>
        <dt>Source Code (Apache-2.0 License)</dt>
        <dd><a href="https://github.com/brdgm/grand-austria-hotel-solo-helper" target="_blank" rel="noopener">https://github.com/brdgm/grand-austria-hotel-solo-helper</a></dd>
      </dl>
...
export default defineComponent({
  ...
  setup() {
    ...
    return { t, route, state, locale, updateServiceWorker }
  },
  data() {
    return {
      buildNumber: version,
